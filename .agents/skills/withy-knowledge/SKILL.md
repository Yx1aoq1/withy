---
name: withy-knowledge
description: Maintain the Withy knowledge base — ingest sources into a cross-linked wiki, answer questions from it, and keep it consistent. Invoked on demand to record a durable lesson or manage the base; you choose what goes in, the skill does the bookkeeping.
---
